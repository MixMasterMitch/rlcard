...
class GoFishPlayer:
    ...
    def remove_cards_of_rank(self, rank):
        ...
        '''
        removed_cards = self.clean_up_rank(rank)
    ...
    def mark_rank_as_requested(self, rank):
        ''' Specifically, this player has requested this rank of another player.
        '''
